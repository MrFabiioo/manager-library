...
const navigation = [
  { name: 'Manager para gestionar: ', href: '#' },
  { name: 'Libros', href: '#' },
  { name: 'Reseñas', href: '#' },
  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-2 lg:px-8 bg-gray-900">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Your Company</span>
              <Image
                alt="imagen" width={100} height={50} 
                src="/images/Creo.png"
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Esta biblioteca virtual es un proyecto de desarrollo en base JavaScript y Node para practicar la coneccion de backend con fronted y una base de datos.
            </p>
