...
export default function NavBar(){
...

  {
    ...
    <div className="space-y-1 px-2 pt-2 pb-3">
      <a target="_blank" href="https://biblioteca-personal.vercel.app" className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Biblioteca</a>
